...
const EconomicBanner = () => {
  ...
  const filteredNationals = economic.slice(1);
  const sortedNational = filteredNationals.sort(
  ...
  const firstNews = sortedNational[0];
  const topThreeNews = sortedNational.slice(0, 3);
